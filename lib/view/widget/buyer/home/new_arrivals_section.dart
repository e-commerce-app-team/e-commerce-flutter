...
/// New Arrivals — horizontal scroll of recently added products.
/// Each card receives a "جديد" badge from the controller data.
      ...
      children: [
        Padding(
          ...
          child: BuyerSectionHeader(
            eyebrow: 'eyebrow_new'.tr,
            title: 'new_arrivals_title'.tr,
            onSeeAll: onSeeAll,
          ),
        ),
