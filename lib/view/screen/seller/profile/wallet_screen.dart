                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildListDelegate([
                          ...
                          _SellerWalletActions(sellerController: ctrl),
                          const SizedBox(height: 20),
                          ...
                          if (ctrl.filteredTransactions.isEmpty)
                            ...
                            ...ctrl.filteredTransactions.asMap().entries.map(
                              (e) => Padding(
                                padding: const EdgeInsets.only(bottom: 10),
                                child: _TxCard(tx: e.value, index: e.key),
                              ),
                            ),
                        ]),
                      ),
...
class _SellerWalletActions extends StatelessWidget {
  final SellerWalletController sellerController;

  const _SellerWalletActions({required this.sellerController});

  @override
  Widget build(BuildContext context) => GetBuilder<WalletController>(
    builder: (controller) => Wrap(
      ...
      children: [
        _SellerWalletAction(
          ...
          onTap: () async {
            final amount = await showWalletAmountDialog(withdrawal: false);
            if (amount != null) await controller.requestDeposit(amount);
          },
        ),
        _SellerWalletAction(
        ...
        _SellerWalletAction(
          ...
          onTap: () => _showWithdrawSheet(context, sellerController),
        ),
        _SellerWalletAction(
        ...
        _SellerWalletAction(
          ...
          onTap: () async {
            ...
            if (result is! Map || result['type'] != 'wallet') return;
...
class _SellerWalletAction extends StatelessWidget {
  final IconData icon;
  final String label;
  final VoidCallback onTap;

  const _SellerWalletAction({
    required this.icon,
    required this.label,
    required this.onTap,
  });
      ...
      child: Column(
        children: [
          ...
          FittedBox(
            ...
            child: Text(
              value,
              style: AppTextStyle.statNumberSmall.copyWith(fontSize: 14),
            ),
          ),
...
class _PendingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(14),
      boxShadow: AppColor.cardShadow,
      border: Border.all(color: AppColor.warning.withOpacity(0.3), width: 0.8),
    ),
    child: Row(
      children: [
        Container(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 3),
              Text(request.requestedAt, style: AppTextStyle.timestamp),
            ],
          ),
        ),
        Column(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: isActive ? ac : AppColor.greyBorder),
...
class _TxCardState extends State<_TxCard> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        Text(tx.date, style: AppTextStyle.timestamp),
                      ],
                    ),
                  ],
                ),
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      children: [
        ...
        const SizedBox(height: 12),
        Text(
          hasFilter ? 'wallet_no_tx_filter'.tr : 'wallet_no_tx'.tr,
          style: AppTextStyle.heading3.copyWith(color: AppColor.grey),
        ),
        const SizedBox(height: 6),
        Text(
          hasFilter ? 'wallet_try_filter'.tr : 'wallet_no_tx_body'.tr,
...
class _WalletShimmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SingleChildScrollView(
    ...
    child: Column(
      children: [
        const ShimmerBox(width: double.infinity, height: 230, radius: 22),
        const SizedBox(height: 14),
        Row(
          children: const [
            Expanded(
              child: ShimmerBox(width: double.infinity, height: 90, radius: 14),
            ),
            SizedBox(width: 10),
            Expanded(
              child: ShimmerBox(width: double.infinity, height: 90, radius: 14),
