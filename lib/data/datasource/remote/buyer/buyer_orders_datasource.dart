...
class BuyerOrdersDataSource {
  ...
  Future<Either<StatusRequest, Map>> getOrders(
    ...
    final url = Uri.parse(AppLink.buyerOrders).replace(queryParameters: params).toString();
  ...
  Future<Either<StatusRequest, Map>> getOrderDetail(
    ...
    String orderId,
      ...
      _crud.getData(AppLink.buyerOrderDetail(orderId), headers: _headers(token));
  ...
  Future<Either<StatusRequest, Map>> confirmDelivery(
    ...
    String orderId,
      ...
      _crud.postData(
        AppLink.buyerConfirmDelivery(orderId),
        {},
