class AppLink {
  ...
  static const String sellerWalletBalance =
      "$server/balance"; // GET - رصيد البائع
  static const String sellerWalletHistory =
      "$server/history"; // GET - سجل السحوبات
  static const String sellerWithdraw =
      "$server/payouts/instant-withdraw"; // POST - سحب
  // Wallet - endpoints مطلوبة من الباك تيم (لم تُنفَّذ بعد)
  static const String sellerWallet =
      "$server/seller/wallet"; // TODO: غير موجود بعد
  static const String sellerWalletTransactions =
      "$server/seller/wallet/transactions"; // TODO: غير موجود بعد
  static const String sellerWalletStats =
      "$server/seller/wallet/stats"; // TODO: غير موجود بعد
  static const String sellerWithdrawRequests =
      "$server/seller/wallet/withdrawals"; // TODO: غير موجود بعد
  ...
  static const String sellerSupportTickets =
      "$server/seller/support/tickets"; // TODO: غير موجود بعد
  ...
  static const String sellerAdsDestroy =
      "$server/ads"; // append: /{id}/destroyAd
  ...
  static const String sellerCouponsShow =
      "$server/vendor/coupons"; // append: /{id}/show
  static const String sellerCouponsUpdate =
      "$server/vendor/coupons"; // append: /{id}/update
  static const String sellerCouponsToggle =
      "$server/vendor/coupons"; // append: /{id}/toggle
  static const String sellerCouponsDestroy =
      "$server/vendor/coupons"; // append: /{id}/destroy
  static const String sellerCouponsStats =
      "$server/vendor/coupons"; // append: /{id}/stats
  ...
  static const String productsFilterCategory =
      "$server/products/filter-by-category";
  static const String productsFilterStatus =
      "$server/products/filter-by-status";
  ...
  static const String departmentsToggle =
      "$server/merchant/departments/toggle-visibility";
  static const String departmentsReorder =
      "$server/merchant/departments/reorder";
  ...
  static const String sellerProfileUpdate =
      "$server/seller/store-settings/update"; // POST
  // Shipping - مطلوب من الباك تيم (غير موجود بعد)
  static const String sellerShippingSettings =
      "$server/seller/shipping-settings"; // TODO: غير موجود بعد
  ...
  static const String invoiceOrderDetail =
      "$server/invoices/order"; // append: /{orderId}
  ...
  static const String buyerCartAdd = "$server/buyer/cart/add";
  static const String buyerCart = "$server/buyer/cart";
  static String buyerCartUpdate(String id) => "$server/buyer/cart/update/$id";
  static String buyerCartRemove(String id) => "$server/buyer/cart/remove/$id";
  static const String buyerCartClear = "$server/buyer/cart/clear";
  ...
  static const String walletSummary = "$server/buyerBalance";
  static const String walletTransactions = "$server/wallet/transactions";
  static const String walletDepositRequests =
      "$server/buyer/wallet/deposit-requests";
  static const String walletWithdrawals = "$server/wallet/withdrawals";
  static const String walletTransfers = "$server/wallet/transfers";
  static const String walletRecipients = "$server/wallet/recipients";
  static const String walletQr = "$server/wallet/qr";
  static const String walletQrResolve = "$server/wallet/qr/resolve";
  static String buyerPayOrder(String orderId) => "$server/orders/$orderId/pay";
  static String subOrderPaymentQr(String id) =>
      "$server/sub-orders/$id/payment-qr";
  ...
  static String buyerProductDetails(String productId) =>
      "$server/buyer/products/$productId";
  static String buyerProductView(String productId) =>
      "$server/products/$productId/view";
